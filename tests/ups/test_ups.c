...
static bool test_1(void)
{
    ...
    const uint8_t patch_data[] = {
        0x55, 0x50, 0x53, 0x31, 0x85, 0x85, 0x80, 0x04, 0x06, 0x00, 0x80, 0x06,
        0x04, 0x00, 0x1c, 0x3a, 0xf5, 0xcb, 0x9f, 0xa0, 0x29, 0x4a, 0x11, 0x89,
        0x4f, 0x1e
    };
    return patch_runner(PatchType_UPS, expected_data, sizeof(expected_data), src_data, sizeof(src_data), patch_data, sizeof(patch_data));
}
...
static bool test_4(void)
{
    ...
    const uint8_t patch_data[] = {
        0x55, 0x50, 0x53, 0x31, 0x85, 0x89, 0x85, 0x36, 0x37, 0x38, 0x39, 0x00,
        0x1c, 0x3a, 0xf5, 0xcb, 0x26, 0x39, 0xf4, 0xcb, 0x52, 0x20, 0x2c, 0x99
    };
    return patch_runner(PatchType_UPS, expected_data, sizeof(expected_data), src_data, sizeof(src_data), patch_data, sizeof(patch_data));
}
...
static bool test_5(void)
{
    ...
    const uint8_t patch_data[] = {
        0x55, 0x50, 0x53, 0x31, 0x89, 0x84, 0x80, 0x42, 0x5f, 0x5c, 0x58, 0x35,
        0x36, 0x37, 0x38, 0x39, 0x00, 0x26, 0x39, 0xf4, 0xcb, 0x06, 0xd2, 0xa0,
        0xbe, 0xd0, 0x25, 0xd3, 0xb6
    };
    return patch_runner(PatchType_UPS, expected_data, sizeof(expected_data), src_data, sizeof(src_data), patch_data, sizeof(patch_data));
}
